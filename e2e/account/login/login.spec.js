...
describe('Login View', function() {
  ...
  it('should include login form with correct inputs and submit button', async function() {
  ...
  it('should include oauth buttons with correct classes applied', async function() {
